...
/* 'TSC Management Information IE within PFCP Session Modification Request' data structure */
...
func (t *TSCManagementInformationIEwithinPFCPSessionModificationRequest) Field() tlv.Field {
	fields := []tlv.Field{}
	...
	return tlv.TLV(TSC_MANAGEMENT_INFORMATION_IE_WITHIN_PFCP_SESSION_MODIFICATION_REQUEST_TYPE, fields...)
}

func (t *TSCManagementInformationIEwithinPFCPSessionModificationRequest) UnmarshalBinary(buf []byte) (err error) {
	*t = TSCManagementInformationIEwithinPFCPSessionModificationRequest{}
