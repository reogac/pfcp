...
/* 'Non-3GPP Access Forwarding Action Information' data structure */
type NonAccessForwardingActionInformation struct {
	FARID    uint32   //FAR ID
	Weight   []byte   //Weight
...
func (t *NonAccessForwardingActionInformation) Field() tlv.Field {
	fields := []tlv.Field{}
	...
	return tlv.TLV(NON__ACCESS_FORWARDING_ACTION_INFORMATION_TYPE, fields...)
}

func (t *NonAccessForwardingActionInformation) UnmarshalBinary(buf []byte) (err error) {
	*t = NonAccessForwardingActionInformation{}
