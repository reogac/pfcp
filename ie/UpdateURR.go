...
func (t *UpdateURR) Field() tlv.Field {
	fields := []tlv.Field{}
	...
	return tlv.TLV(UPDATE_URR_TYPE, fields...)
}

func (t *UpdateURR) UnmarshalBinary(buf []byte) (err error) {
	*t = UpdateURR{}
